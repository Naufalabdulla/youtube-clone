...
const Navbar = (props) => {
    return(
        <nav className='w-full py-1 px-4 sticky top-0 bg-primary'>
          ...
          <div className='flex w-full items-center justify-between py-1'>
            ...
            <div className='flex gap-2 items-center'>
              <input className='flex rounded-full bg-inherit border border-neutral-700 px-3 py-2 w-96 focus:outline-blue-600' placeholder='search' type="text" name="" id="" />
